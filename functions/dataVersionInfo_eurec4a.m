function versionInfo = dataVersionInfo_eurec4a

versionInfo = {0,   0,  'Raw data without any modification';
               0,   1,  '2D version of Bahamas data and single sonde data added';
